...
var AppRoutes = (
  React.createElement(Route, {name: "app", path: "/", handler: Root}, 
    ...
    React.createElement(Route, {name: "following_tags", path: "/following_tags", handler: FollowTags}), 
    React.createElement(Route, {name: "stock_tags", path: "/stock_tags", handler: StockTags})
  )
);

module.exports = AppRoutes;

},{"./follow_tag.jsx":3,"./followees.jsx":4,"./stock_index.jsx":5,"./stock_tags_index.jsx":6,"react":205,"react-router":32}],2:[function(require,module,exports){
(function() {
  var React = require('react');
...
var FollowTags = React.createClass({displayName: "FollowTags",
  ...
  render() {
    ...
    this.state.following_tags.forEach(function(tag) {
      rows.push(
        React.createElement("div", {key: tag.id, className: "following-tags-item"}, 
          React.createElement("div", {className: "following-tags-item__id"}, tag.id), 
          React.createElement("div", {className: "following-tags-item__icon"}, React.createElement("img", {src: tag.icon_url}))
        )
      )
    }.bind(this));
    return(
      React.createElement("div", {className: "following-tags-list"}, 
        rows
      )
    );
  }
...
},{"react-router":32}],4:[function(require,module,exports){
var Router = require('react-router');
var Link = Router.Link;
var Navigation = Router.Navigation;
...
var StockTags= React.createClass({displayName: "StockTags",
  fetchStockTags() {
    $.get('/stocks.json', function(res) {
      if(this.isMounted()) {
  ...
  render() {
    ...
    this.state.stockTags.forEach(function(tag) {
      rows.push(
        React.createElement("div", {key: tag.name, className: "stock-tag-item"}, 
          React.createElement("div", {className: "stock-tag-item__name"}, tag.name)
        )
      )
    }.bind(this));
    return (
      React.createElement("div", {className: "stock-tags-list"}, 
        rows
      )
    );
  }
